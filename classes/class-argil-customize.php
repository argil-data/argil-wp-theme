...
if (!class_exists('argil_Customize')) {
    /**
     * Customizer Settings.
     *
     * @since argil 1.0
     */
    class argil_Customize
    {
        ...
        public function register($wp_customize)
        {
            ...
            $wp_customize->add_control(
                ...
                array(
                    ...
                    'label'   => esc_html__('Display Site Title & Tagline', 'argil'),
                )
            );
            ...
            $wp_customize->add_section(
                'excerpt_settings',
                array(
                    'title'    => esc_html__('Excerpt Settings', 'argil'),
                    'priority' => 120,
                )
            );
            ...
            $wp_customize->add_control(
                ...
                array(
                    ...
                    'label'   => esc_html__('On Archive Pages, posts show:', 'argil'),
                    'choices' => array(
                        'excerpt' => esc_html__('Summary', 'argil'),
                        'full'    => esc_html__('Full text', 'argil'),
                    ),
                )
            );
