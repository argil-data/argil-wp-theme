...
function argil_skip_link_focus_fix()
{
    ...
    if (defined('SCRIPT_DEBUG') && SCRIPT_DEBUG) {
        echo '<script>';
        include get_template_directory() . '/public/assets/js/skip-link-focus-fix.js';
        echo '</script>';
    } else {
...
function argil_customize_preview_init()
{
    wp_enqueue_script(
        ...
        get_theme_file_uri('/public/assets/js/customize-helpers.js'),
        array(),
    ...
    wp_enqueue_script(
        ...
        get_theme_file_uri('/public/assets/js/customize-preview.js'),
