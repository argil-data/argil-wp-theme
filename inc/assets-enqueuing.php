...
function argil_scripts()
{
    ...
    if ($is_IE) {
        ...
        wp_enqueue_style('argil-style', get_template_directory_uri() . '/dist/assets/css/ie.css', array(), wp_get_theme()->get('Version'));
    } else {
    ...
    // Print styles.
    wp_enqueue_style('argil-print-style', get_template_directory_uri() . '/dist/assets/css/print.css', array(), wp_get_theme()->get('Version'), 'print');
    ...
    wp_register_script(
        ...
        get_template_directory_uri() . '/dist/assets/js/polyfills.js',
        array(),
    ...
    //         get_template_directory_uri() . '/dist/assets/js/primary-navigation.js',
    ...
    //     get_template_directory_uri() . '/dist/assets/js/responsive-embeds.js',
    //     array('argil-ie11-polyfills'),
    //     wp_get_theme()->get('Version'),
    //     true
    // );
...
function argil_styles_enqueuing()
{
    ...
    wp_register_style('argil', get_template_directory_uri() . '/dist/assets/css/main.css', array(), wp_get_theme()->get('Version'), 'all');
    // wp_register_style('argil-bundle', get_template_directory_uri() . '/dist/assets/css/bundle.css', array(), wp_get_theme()->get('Version'), 'all');
    // wp_register_style('ada-editor', get_template_directory_uri() . '/dist/assets/dist/editor.css', array('argil'), wp_get_theme()->get('Version'), 'all');
    // wp_register_style('ada-admin', get_template_directory_uri() . '/dist/assets/css/admin.css', array('argil'), wp_get_theme()->get('Version'), 'all');
...
function argil_scripts_enqueuing()
{
    ...
    $theme = wp_get_theme();
    wp_register_script('argil-vendor', get_template_directory_uri() . '/dist/assets/js/vendor.js', array(), wp_get_theme()->get('Version'), true);
    wp_register_script('argil', get_template_directory_uri() . '/dist/assets/js/main.js', array(), wp_get_theme()->get('Version'), true);
    wp_register_script('argil-bundle', get_template_directory_uri() . '/dist/assets/js/bundle.js', array(), wp_get_theme()->get('Version'), true);
    // wp_enqueue_script('manifest', get_template_directory_uri() . '/dist/assets/js/manifest.js', array(), $theme->get('Version'), true);
    ...
    if (is_page('community') || is_archive('ada_labs')) {
        wp_register_script('page-labs', get_template_directory_uri() . '/dist/assets/js/page-labs.js', array(), '1.6.0', true);
...
{
    wp_enqueue_script('argil-editor', get_theme_file_uri('/dist/assets/js/editor.js'), array('wp-blocks', 'wp-dom'), wp_get_theme()->get('Version'), true);
}
...
//         wp_enqueue_script('argil', 'http://localhost:5173/src/assets/js/index.js', [], null);
