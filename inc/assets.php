...
namespace ArgilTheme\inc\assets;
...
function addScript()
{
    ...
    if (WP_ENV !== 'development') {
        ...
        foreach ($sc as $key => $value) {
            wp_enqueue_script('argil-theme-' . $value['token'] . '/dist/assets/' . $value['file'], array(), $value['token'], true);
            // add prefetch
...
function enqueue_scripts()
{
    add_filter('script_loader_tag', function ($tag, $handle, $src) {
        if (strpos($handle, 'argil-theme') === false) {
            return $tag;
        }
